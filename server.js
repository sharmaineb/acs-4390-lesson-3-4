...
// build Schema
// Modify your schema to include a new input type for Coordinates
...
//     getWeatherByCity(city: String!, units: Units): WeatherResult!
//     getWeatherByCityId(cityId: Int!, units: Units): WeatherResult!
//     getWeatherByCoordinates(lat: Float!, lon: Float!, units: Units): WeatherResult!
//   }
// `);
...
//   getWeatherByCoordinates: async ({ lat, lon, units = 'imperial' }) => {
//     const apikey = process.env.OPENWEATHERMAP_API_KEY;
//     const url = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=${apikey}&units=${units}`;
//     return handleWeatherRequest(url);
//   },
